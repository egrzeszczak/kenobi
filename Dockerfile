...
LABEL org.label-schema.vcs-url="https://github.com/egrzeszczak/kubernetes-lab"
# LABEL org.label-schema.docker.cmd="docker run --rm -d -p 3000:3000/tcp username/image"
